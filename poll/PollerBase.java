...
abstract class PollerBase implements Runnable {
  ...
  /**
   * Load of the poller. Currently the number of file descritpors
   * registered
   */
  ...
  /**
   * the thread where all events will be dispatched. So
   * the actual IO or Reaper threads
   */
  ...
  /**
   * Returs load of the poller. Note tha this function can be
  ...
  /**
   * Cacel the timer created by sink_ object with ID equals to ID
   */
  ...
  /**
   * Execute any timers that are due. Returns number of
   * milliseconds to wait to match
